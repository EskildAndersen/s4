    ...
    def forward(
        ...
        if self.n_clusters == 0:
            ...
            for i in range(len(cutoff_values) - 1):
                ...
                offset += logprob_i.size(
                    0
                )  # TODO This should be a bug in the original implementation; it should go into the continue case above as well
