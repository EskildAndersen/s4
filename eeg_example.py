...
parser = argparse.ArgumentParser(description="PyTorch EEG Training")
# Optimizer
...
# Dataloader
parser.add_argument(
    "--num_workers", default=0, type=int, help="Number of workers to use for dataloader"
)
...
dataset.updateDataSet(100, 100, 1)
